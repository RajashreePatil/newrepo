...
public class JavaEEComponentFinderStrategyCopy extends AbstractComponentFinderStrategy {
    ...
    @Override
    protected Set<Component> doFindComponents1() {
     ...
     @Override
    protected Set<Component> doFindComponents2() {
        Set<Component> components = new HashSet<>();
     ...
     @Override
    protected Set<Component> doFindComponents3() {
        Set<Component> components = new HashSet<>();
     ...
     @Override
    protected Set<Component> doFindComponents4() {
        Set<Component> components = new HashSet<>();
